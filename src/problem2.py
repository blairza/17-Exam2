...
class Triangle(object):
    ...
    def area(self):
        ...
        s2 = self.a.distance_from(self.c)
        s3 = self.b.distance_from(self.c)
        s =  (1/2) * (s1 + s2 + s3)
    ...
    def shrink_or_expand(self, f):
        ...
        self.c.x = self.c.x * f
        self.c.y = self.c.y * f
        if(self.area() > self.largestare):
            self.largestare = self.area()
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        tri = Triangle(Point(self.a.x * 2, self.a.y * 2),Point(self.b.x * 2, self.b.y * 2),Point(self.c.x * 2, self.c.y * 2))
        return tri
...
def run_test_return_doubled_triangle():
    ...
    pt2 = Point(30,40)
    pt3 = Point(10,10)
    tri1 = Triangle(pt1,pt2,pt3)
    tri2 = tri1.return_doubled_triangle()

    expecteda = Point(80,50)
    expectedb = Point(60, 80)
    expectedc = Point(20, 20)
    run_test_instance_variables(tri2, expecteda, expectedb, expectedc)
